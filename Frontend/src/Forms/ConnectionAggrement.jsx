...
const ConnectionAggrement = () => {
    ...
    const submitHandler = async(e) => {
        ...
        try{
            ...
            let response = await axios.put(`http://localhost:4000/api/admin/connection/${user._id}` , user )
    ...
    <>
        <form onSubmit={submitHandler}>
            ...
            <div>
                        ...
                        <p><b>The Distribution Licensee- Maharashtra State Electricity Distribution Co. Ltd; and having its Registered Office at <input type="text" className='lines' name='second_address' required onChange={userhandler} />as second Party of this Agreement;</b></p>
...
export default ConnectionAggrement
