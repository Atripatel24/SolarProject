...
const PrintFormat = () => {
    ...
    return (
        <>
            <div className='detail' ref={formRef}>
                <div className="insideform">
                    ...
                    <p>
                        <b>
                            We Mayur Pramod Dhokale[Vendor]&<input type="text" class="lines" id="" name=""
                                required />[Consumer]
                            bearing Consumer Number<input type="text" class="lines" value={user.name} /> Ensured structural stability of
                    ...
                    <br />
                    <label for="imageUpload">Signature[consumer]</label>
                    <input type="file" id="imageUpload" accept="image/*" />
                    <br /><br />
                    <img id="imagePreview" src="" alt="Image Preview" style={{ display: 'none', maxWidth: '100%', height: 'auto' }} />
                    ...
                    <div>
                        <label style={{ marginTop: '250px' }}>Identity Details of Consumer :-</label><br />
                        <div className='inline-container'>
                            <label htmlFor="">Aadhar Number :</label>
                            <input type="text" class='lines'
                                style={{ width: 'auto' }}
                    ...
                    <div>
                        ...
                        <p>
                            <b>Certified that a Grid Connected SPV Power Plant of <input type="text" className='lines' value={user.total_capacity} disabled /> KWp capacity has been installed at the site <input type="text" className='lines' value={user.site_location} disabled /> District<input type="text" className='lines' required /> of MAHARASHTRA which has been installed by M/S <input type="text" className='lines' required /> on <input type="date" required value={user.installation_date} disabled className='lines' /> The system is as per BIS/MNRE specifications. The system has been checked for its performance and found in order for further commissioning.</b>
                        </p>
                        ...
                        <p> <b>The above RTS installation has been inspected by me for Pre-Commissioning Testing of Roof Top Solar Connection on dt <input type="date" className='lines' value={user.connection_date} disabled /> as per guidelines issued by the office of The Chief Engineer vide letter no 21653 on dt. 18.08.2022 and found in order for commissioning. </b></p>
                    ...
                    <div>
                        ...
                        <p><b>
                            1. This is to certify that M/S Mayur Pramod Dhokale has installed {user.num_modules * user.wattage_per_module} KW [Capacity] Grid Connected Rooftop Solar Plant for {user.name} [Consumer Name] at {user.site_location} [Address] under application number {user.sanction_number} dated {user.declaration_date}.[date of application] under {user.discom} [DISCOM Name].
                        </b></p>
                    ...
                    <div style={{ marginTop: '400px' }}>
                        ...
                        <p><b>And whereas, the Licensee has agreed to provide Network connectivity to the Eligible Consumer for injection of electricity generated from its Roof-top Solar PV System of {user.num_modules * user.wattage_per_module} kilowatt;<br />Both Parties hereby agree as follows:-</b></p>
                        <br />
