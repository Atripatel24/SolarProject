...
const ModelAgreement = () => {
    ...
    let submitHandler = async (e) => {
        ...
        if (params.id) {
            let response = await axios.put(`https://admin.samarthenergysolution.com/api/model/${params.id}`, user)
            ...
            <form onSubmit={submitHandler}>
                <div className="insideform">
                    <div class="agreement-container">
                        ...
                        connection with consumer number {user.consumer_number} from {user.discom_name}   (DISCOM) at {user.discom_address}
                        ...
                        <section>
                            ...
                            <ol>
                                ...
                                <ul>
                                    <li><input type='text' name="advance" value={user.advance} onChange={userhandler} style={{ width: "5%" }}></input> % as an advance on confirmation of the order.</li>
                                    <li><input type='text' name="before" value={user.before} onChange={userhandler} style={{ width: "5%" }}></input>% before dispatch of solar panels, inverters, and BoS items.</li>
                                    <li><input type='text' name="after" value={user.after} onChange={userhandler} style={{ width: "5%" }}></input>% after installation and commissioning.</li>
                                </ul>
