        ...
        <div className="insideform">
            <form onSubmit={submitHandler}>
                    ...
                    <div class="form-section">
                        ...
                        <input type="text" id="sanction-number" maxLength={12} name="sanction_number" required onChange={userhandler} onKeyDown={handleKeyDown} value={user.sanction_number}/>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <input type="text" id="sanctioned-capacity" maxLength={4} name="sanctioned_capacity" required onChange={userhandler} onKeyDown={handleKeyDown} value={user.sanctioned_capacity}/>

                        <label for="installed-capacity">Installed Capacity (KW)</label>
                        <input type="text" id="installed-capacity" maxLength={4} name="installed_capacity" required onChange={userhandler} onKeyDown={handleKeyDown} value={user.installed_capacity}/>
                        ...
                        <input type="text" id="almm-model" name="almm_model" onChange={userhandler} maxLength={15} onKeyDown={handleKeyDown} value={user.almm_model}/>

                        <label for="wattage-per-module">Wattage Per Module<span>*</span></label>
                        <input type="text" id="wattage-per-module" name="wattage_per_module" maxLength={4} required onChange={userhandler} onKeyDown={handleKeyDown} value={user.wattage_per_module}/>

                        <label for="num-modules">Number of Modules<span>*</span></label>
                        <input type="key" id="num-modules" name="num_modules" required onChange={userhandler} maxLength={4} onKeyDown={handleKeyDown} value={user.num_modules}/>
                    ...
                    <div class="form-section">
                        ...
                        <input type="text" id="inverter-make" name="inverter_make" maxLength={15} required onChange={userhandler} value={user.inverter_make}/>
                        ...
                        <input value={'Rooftop'} disabled />
                        <br />



                        <label for="inverter-capacity">Capacity of Inverter:</label>
                        <input type="text" id="inverter-capacity" name="inverter_capacity" maxLength={4} required onChange={userhandler} value={user.inverter_capacity}/>

                        <label for="hpd">HPD:</label>
                       
                        <select id="hpd" name="hpd" onChange={userhandler} onKeyDown={handleKeyDown} required value={user.hpd}>
                    ...
                    <option value="2050">2050</option>
                        ...
                        <input type="text" id="earth-resistance" name="earth_resistance" maxLength={4} required onChange={userhandler} onKeyDown={handleKeyDown} value={user.earth_resistance}/>
...
<br/><br/>
                    <div>
                        ...
                        <div className='inline-container'>
                            ...
                            <input type="text" class='lines' name='aadhar_number' required style={{ width: 'auto' }} onKeyDown={handleKeyDown} onChange={userhandler} maxLength={12} value={user.aadhar_number} />
                        </div>
                        {files.length === 0 ? (
