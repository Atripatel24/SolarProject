        ...
        <>
            <div className='a4-page-connectionagreement'>
                ...
                <div className='hello'>
                    ...
                    <div className='hello'>
                        <div >
                            <label>Witness 1(VENDOR):

                            </label>
                            <img src={stamp} alt="Stamp & Seal" style={{ height: "150px", width: "200px" }} />
                            Stamp [samarthenergysolution]

                        </div>
                        <div>
                         <label style={{marginLeft:"100px"}}>Witness 1:</label>
